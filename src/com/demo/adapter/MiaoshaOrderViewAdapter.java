...
public class MiaoshaOrderViewAdapter extends MyAdapter {
	   ...
	   private Context context;                        //运行上下文   
	    ...
	    public MiaoshaOrderViewAdapter(Context context) {  
	        this.context = context;           
	        listContainer = LayoutInflater.from(context);   //创建视图容器并设置上下文   
	        this.listItems=new ArrayList<Map<String, Object>>();
	    } 	      
	    public MiaoshaOrderViewAdapter(Context context, List<Map<String, Object>> listItems) {  
	        this.context = context;           
	        listContainer = LayoutInflater.from(context);   //创建视图容器并设置上下文   
	  ...
	  public void addItem(Map<String,Object> o){
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {  
	        ...
	        if (convertView == null) {  
	            ...
	            //获取list_item布局文件的视图   
	            convertView = listContainer.inflate(R.layout.list_item_miaoshaorder, null);  
	            //获取控件对象     
	            listItemView.ordertime = (TextView)convertView.findViewById(R.id.ordertime);
	        ...
	        if(listItemView.image.getDrawable()==null){
		        ...
		        listItemView.title.setText((String) listItems.get(position)  
		                .get("title")); 
		        listItemView.ordertime.setText((String) listItems.get(position)  
		                .get("ordertime")); 
