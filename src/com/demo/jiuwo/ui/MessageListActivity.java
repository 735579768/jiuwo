...
public class MessageListActivity extends BaseActivity implements MyProgressBar,OnPullListener {
			           	...
			           	if(!TextUtils.isEmpty(category_id)){
				            ...
				            try{
				            	...
				            	resetRefresh();
				           		...
				           		searching=false;
				           		resetRefresh();
						    	Toast.makeText(MessageListActivity.this, "已经没有内容啦！",
		    ...
		    goodslistview.setOnItemClickListener(new OnItemClickListener(){
				...
				public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					...
					String titleitem=map.get("id").toString();	
						...
						intent.setClass(MessageListActivity.this,GoodsActivity.class);
						startActivity(intent);
						inright();
					}catch(Exception e){
						e.printStackTrace();
